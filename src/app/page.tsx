...
export default async function Home() {
  ...
  return (
    <div className="relative flex min-h-0 flex-1 flex-col overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-0 w-full max-w-7xl flex-1 flex-col justify-center px-4 py-6 sm:px-6 sm:py-8 lg:grid lg:grid-cols-2 lg:items-center lg:gap-12 lg:px-8 lg:py-10 xl:gap-16">
        <div className="min-w-0 text-center lg:text-left">
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-teal-300 sm:text-sm">
            Consultation à domicile
          </p>
          <h1 className="mt-3 text-balance text-3xl font-bold leading-[1.1] tracking-tight text-white sm:text-4xl lg:mt-4 lg:text-[2.85rem] xl:text-5xl">
